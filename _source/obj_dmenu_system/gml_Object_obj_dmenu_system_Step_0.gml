...
function evaluate_custom_flag(arg0, arg1)
{
    ...
    if (string_length(dcustom_flag_text[1]) == 0)
    {
        if (proper_exit)
            ...
            scr_debug_print(gml_Script_scr_dmode_get_text("dbg_empty_val"));
    ...
    if (proper_exit)
    {
        scr_debug_print(gml_Script_scr_dmode_get_text("dbg_updated") + "global.flag[" + string(real(dcustom_flag_text[0])) + "]" + gml_Script_scr_dmode_get_text("dbg_from") + "|" + string(global.flag[real(dcustom_flag_text[0])]) + "|" + gml_Script_scr_dmode_get_text("dbg_to") + "|" + dcustom_flag_text[1] + "|");
...
if (dmenu_active && global.dreading_custom_flag)
{
    ...
    {
        update_visu = gml_Script_scr_read_keyboard();
        flag_index = 0;
...
else if (dmenu_active)
{
    ...
    if (dbutton_layout == 1)
    {
        ...
        if (dmenu_state == "flag_misc")
        {
            ...
            if (playsound)
            {
                ...
                scr_debug_print(gml_Script_scr_dmode_get_text("dbg_updated") + "global.flag[" + string(cur_options[2]) + "]" + gml_Script_scr_dmode_get_text("dbg_to") + "|" + string(cur_options[3][dhorizontal_index][1]) + "|");
                snd_play(snd_menumove);
            }
        }
    ...
    if (keyboard_check_pressed(global.input_k[4]) || keyboard_check_pressed(global.input_k[7]))
    {
            ...
            switch (dmenu_state)
            {
                case "objects":
                    if (dhorizontal_page != 0 || dvertical_index != 0)
                    {
                        ...
                        scr_debug_print(dgiver_bname + gml_Script_scr_dmode_get_text("msg_selected"));
                    }
                ...
                case "armors":
                    if (dhorizontal_page != 0 || dvertical_index != 0)
                    {
                        ...
                        scr_debug_print(string(dgiver_bname) + gml_Script_scr_dmode_get_text("msg_selected"));
                    }
        ...
        {
            scr_debug_print(gml_Script_scr_dmode_get_text("msg_search_selected"));
        }
        else if (dmenu_state != "givertab" && dmenu_state != "flag_misc" && dmenu_state != "warp_options" && (dmenu_state != "recruits" || dvertical_index == 0))
        {
            ...
            scr_debug_print(option_name + gml_Script_scr_dmode_get_text("msg_selected"));
        }
    ...
    if (dhinter_active)
    {
        if (dmenu_state == "warp_options")
        {
            ...
            dhinter_text = gml_Script_scr_dmode_get_text("hint_room") + room_get_name(new_room);
        }
        ...
        if (scr_array_contains(ditem_types, dmenu_state))
        {
            if (dhorizontal_page == 0 && dvertical_index == 0)
            {
                dhinter_text = gml_Script_scr_dmode_get_text("hint_press") + scr_get_input_name(4) + gml_Script_scr_dmode_get_text("hint_change_chap");
            }
