...
if (dmenu_active)
{
    ...
    if (dmenu_state == "debug" && global.darkzone == 1)
    {
        ...
        draw_text(draw_x, draw_y, string(gml_Script_scr_dmode_get_text("ui_m_keys")));
        draw_set_font(fnt_mainbig);
    }
    ...
    if (global.dreading_custom_flag)
    {
        ...
        draw_text(draw_x, draw_y, string(gml_Script_scr_dmode_get_text("ui_esc_cancel")));
    ...
    if (global.dreading_custom_flag)
    {
        ...
        else if (dmenu_state == "warp")
        {
            ...
            var visual_offset = -2;
            var cursor_padding = 3 * d;
            var w_prefix = string_length(string(gml_Script_scr_dmode_get_text("ui_contains"))) * mono_spacing;
            var w_name = string_length(string(dcustom_flag_text[0])) * mono_spacing;
            var x1_start = base_x + w_prefix;
        ...
        else if (dmenu_state == "warp_options")
        {
            ...
            var visual_offset = -2;
            var cursor_padding = 3 * d;
            var w_prefix = string_length(string(gml_Script_scr_dmode_get_text("ui_plot_value"))) * mono_spacing;
            var w_name = string_length(string(dcustom_flag_text[0])) * mono_spacing;
            var x1_start = base_x + w_prefix;
            var x2_start = x1_start + w_name;
            draw_set_color(c_yellow);
    ...
    if (dmenu_state == "recruits" || dmenu_state == "weapons" || dmenu_state == "armors" || dmenu_state == "objects")
    {
        ...
        {
            if (dhorizontal_page != 0)
                draw_text(draw_x, draw_y, "(" + string(gml_Script_scr_dmode_get_text("ui_chap_short")) + " " + string(dhorizontal_page) + ")");
            else
                draw_text(draw_x, draw_y, string(gml_Script_scr_dmode_get_text("ui_chap_all")));
        }
        else if (dhorizontal_page == 0)
        {
            draw_text(draw_x + 30 + (global.darkzone * 30), draw_y, string(gml_Script_scr_dmode_get_text("ui_world_dark")));
        ...
        {
            draw_text(draw_x + 30 + (global.darkzone * 30), draw_y, string(gml_Script_scr_dmode_get_text("ui_world_light")));
    ...
    if (dbutton_layout == 2)
    {
        ...
        if (dgiver_menu_state == "objects")
        {
            ...
            draw_text(x_start + xx, ((ycenter + 25) * d) + yy, string(gml_Script_scr_dmode_get_text("ui_inv_items")) + string(max_items - itemcount) + " / " + string(max_items));
        }
        ...
        if (dgiver_menu_state == "armors")
        {
            ...
            draw_text(x_start + xx, ((ycenter + 25) * d) + yy, string(gml_Script_scr_dmode_get_text("ui_inv_armors")) + string(48 - itemcount) + " / 48");
        }
        ...
        if (dgiver_menu_state == "weapons")
        {
            ...
            draw_text(x_start + xx, ((ycenter + 25) * d) + yy, string(gml_Script_scr_dmode_get_text("ui_inv_weapons")) + string(48 - itemcount) + " / 48");
        }
        ...
        if (dgiver_menu_state == "keyitems")
        {
            itemreminder = "[" + string(dgiver_bname) + "]";
            scr_keyitemcheck(0);
            draw_text(x_start + xx, ((ycenter + 25) * d) + yy, string(gml_Script_scr_dmode_get_text("ui_inv_keyitems")) + string(12 - itemcount) + " / 12");
        }
...
if (dkeys_helper == 1)
{
    dkeys_data = [string(gml_Script_scr_dmode_get_text("key_0")), string(gml_Script_scr_dmode_get_text("key_1")), string(gml_Script_scr_dmode_get_text("key_2")), string(gml_Script_scr_dmode_get_text("key_3")), string(gml_Script_scr_dmode_get_text("key_4")), string(gml_Script_scr_dmode_get_text("key_5")), string(gml_Script_scr_dmode_get_text("key_6")), string(gml_Script_scr_dmode_get_text("key_7")), string(gml_Script_scr_dmode_get_text("key_8")), string(gml_Script_scr_dmode_get_text("key_9")), string(gml_Script_scr_dmode_get_text("key_10")), string(gml_Script_scr_dmode_get_text("key_11")), string(gml_Script_scr_dmode_get_text("key_12")), string(gml_Script_scr_dmode_get_text("key_13")), string(gml_Script_scr_dmode_get_text("key_14"))];
    x_padding = 7;
    y_start = 50 * d;
    x_spacing = 10 * d;
    y_spacing = 10.5 * d;
    ...
    var draw_x = (right_border + xx) - padding;
    var draw_y = (((ycenter - (menu_length / 2)) + 8) * d) + yy;
    draw_text(draw_x, draw_y, string(gml_Script_scr_dmode_get_text("ui_m_close")));
    draw_set_halign(fa_left);
    draw_set_color(c_white);
    draw_text(x_start + xx, (((ycenter - (menu_length / 2)) + 8) * d) + yy, string(gml_Script_scr_dmode_get_text("ui_keys_title")));
