function scr_string_respect_type(arg0, arg1, arg2, arg3)
{
    ...
    {
        scr_debug_print(gml_Script_scr_dmode_get_text("dbg_empty_flag"));
        return 0;
    }
    ...
    for (c = 1; c <= string_length(str); c++)
    {
        ...
        if (type != "variable")
        {
            ...
            {
                if (print_error)
                    scr_debug_print(gml_Script_scr_dmode_get_text("dbg_inv_flag") + "|" + string(str) + "|" + gml_Script_scr_dmode_get_text("dbg_because") + "|" + cur_char + "|");
